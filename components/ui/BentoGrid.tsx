...
import GridGlobe from "@/components/ui/GlobeGrid";
...
export const BentoGridItem = ({
    ...
    const leftLists = ["ReactJS", "MERN", "Typescript"];
    const rightLists = ["Wordpress", "NextJS", "PHP"];
    ...
    const handleCopy = () => {
        const text = "radek.dumin@gmail.com";
